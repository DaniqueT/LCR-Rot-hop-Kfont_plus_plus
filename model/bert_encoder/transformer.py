...
class TransformerLayer(nn.Module):
    ...
    def __init__(self, args, layer, currentLayerIndex, dense1,dense2,proj1,proj2, word2vec, ontology):
        ...
        self.feed_forward = PositionwiseFeedForward(
            args.hidden_size, args.feedforward_size, layer, currentLayerIndex= self.currentLayerIndex, dense1=dense1, dense2=dense2, proj1=proj1, proj2=proj2, word2vec=self.word2vec_model, ontology=self.ontology
        )
