...
from .modeling_attn_mask_utilsNew import (
...
class BertSdpaSelfAttention(BertSelfAttention):
    def __init__(self, config, position_embedding_type=None):
        ...
        self.require_contiguous_qkv = version.parse(torch_version) < version.parse("2.2.0")
