...
class HyperOptManager:
    ...
    def __init__(self, year: int, val_ont_hops: Optional[int]):
        ...
        self.__checkpoint_dir = f"data/checkpoints/{year}_epochs{self.n_epochs}_hop1_trainknow"
    ...
    def objective(self, hyperparams):
        ...
        path_owl = "data/myontology2016/output"
        word2vec_model = gensim.models.Word2Vec.load(path_owl)
